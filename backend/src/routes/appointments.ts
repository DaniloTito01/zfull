...
router.get('/calendar', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
...
router.get('/:id', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
...
router.post('/', authenticateToken, requireBarbershopAccess, requireRole(['admin', 'barbeiro']), async (req: AuthRequest, res) => {
  try {
    const {
      barbershop_id,
      client_id,
...
router.put('/:id', authenticateToken, requireBarbershopAccess, requireRole(['admin', 'barbeiro']), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
    const {
      client_id,
...
router.put('/:id/status', authenticateToken, requireBarbershopAccess, requireRole(['admin', 'barbeiro']), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', authenticateToken, requireBarbershopAccess, requireRole(['admin', 'barbeiro']), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
...
router.get('/available-slots', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
