...
router.get('/daily', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
...
router.get('/reports', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
