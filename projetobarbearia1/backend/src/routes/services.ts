...
router.get('/categories', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
...
router.get('/:id/stats', authenticateToken, requireBarbershopAccess, async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
...
router.post('/:id/duplicate', authenticateToken, requireBarbershopAccess, requireRole(['admin', 'barbeiro']), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
